...
vtubers! {
    ...
    "lamy",         Some("UCFKOVgVbGmX65RxO3EtH3iw"), None,
    "nene",         Some("UCAWSyEs_Io8MtpY3m-zqILA"), None,
    "botan",        Some("UCUKD-uaobj9jiqB-VXt71mA"), None,
    "aloe",         Some("UCgZuwn-O7Szh9cAgHqJ6vjw"), None,
    "polka",        Some("UCK9V2B22uJYu3N7eR_BT9QA"), None,
